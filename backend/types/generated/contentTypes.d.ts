...
export interface ApiRestaurantRestaurant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pricing: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiStayStay extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Manage hotels, homestays and other accommodations';
    displayName: 'Stay';
    pluralName: 'stays';
    singularName: 'stay';
  };
  ...
  attributes: {
    availabilityEnd: Schema.Attribute.Date;
    availabilityStart: Schema.Attribute.Date;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText;
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Manage tour packages and activities';
    displayName: 'Tour';
    pluralName: 'tours';
    singularName: 'tour';
  };
